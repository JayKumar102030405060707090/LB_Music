...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Yari_DOSTII")
...
if SUPPORT_CHANNEL:
    if not re.match("https://t.me/dpz_duniya", SUPPORT_CHANNEL):
        raise SystemExit(
            "[ERROR] - Your SUPPORT_CHANNEL url is wrong. Please ensure that it starts with https://"
        )

if SUPPORT_CHAT:
    if not re.match("https://t.me/Yari_DOSTII", SUPPORT_CHAT):
        raise SystemExit(
